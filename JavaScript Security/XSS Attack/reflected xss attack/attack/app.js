...
console.log(name)
    ...
    res.send(`
    <link rel="stylesheet" href="style.css"><h1 id="heading"> Hi <b>  ${name}</b>  !! Welcome to FilmyGossip</h1><br>
    <div id="container">
    <h2 id="title">
    <u>About FilmyGossip</u>

    </h2><br><p>FilmyGossip provides you the trendy updates and reviews of latest Movies. You can register with us to get the feed in your mail.
